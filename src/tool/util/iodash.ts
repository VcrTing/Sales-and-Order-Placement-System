...
export const arrfindi = <T>(arr: T[], tar: number | string, k: string = 'documentId'): number => {
    let _i = -1
...
export const arrfind = <T>(arr: T[], tar: number | string, k: string = 'documentId'): T => (arr[ arrfindi(arr, tar, k) ])
